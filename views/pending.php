                    ...
                    <div class="card-body p-3">
                        <div class="row h-100">
                            <div class="col-md-12 d-flex flex-column justify-content-center align-items-center text-center">
                                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../assets/pendin.png" class="d-block w-100 img-fluid" alt="Persona trabajando en laptop">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../assets/pendin.png" class="d-block w-100 img-fluid" alt="Persona trabajando en laptop 2">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../assets/pendin.png" class="d-block w-100 img-fluid" alt="Persona trabajando en laptop 3">
                                        </div>
                                    </div>
                                ...
                                <h2 class="fw-bold mb-3">¡Bienvenido(a) <span class="text-danger"><?php echo $nombre; ?></span>!</h2>
                                <p class="text-muted">
                                    A tus tareas pendientes.
                                </p>
                            </div>
                        </div>
                    </div>
