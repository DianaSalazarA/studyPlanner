                                ...
                                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../assets/finish.png" class="d-block w-100 img-fluid" alt="Persona trabajando en laptop">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../assets/finish.png" class="d-block w-100 img-fluid" alt="Persona trabajando en laptop 2">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../assets/finish.png" class="d-block w-100 img-fluid" alt="Persona trabajando en laptop 3">
                                        </div>
                                    </div>
