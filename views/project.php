        ...
        <div class="col ">
                ...
                <div class="offcanvas-body p-3">
                    <ul class="navbar-nav flex-column">
                        <li class="nav-item mb-2">
                            <a class="nav-link text-white" href="./home.php"><i
                                    class="bi bi-house-door me-2"></i>Inicio</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a class="nav-link text-white" href="./project.php"><i
                                    class="bi bi-folder me-2"></i>Proyectos</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a class="nav-link text-white" href="./tasks.php"><i
                                    class="bi bi-folder me-2"></i>Tareas</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a class="nav-link text-white" href="./calendar.php"><i
            ...
            <div class="container mt-4">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3 mb-4">
                    <div class="col">
                        <a href="../views/important.php"
                            class="btn btn-primary w-100 d-flex justify-content-between align-items-center btn-important">
                    ...
                    <div class="col">
                        <a href="../views/Pendings.php"
                            class="btn btn-primary w-100 d-flex justify-content-between align-items-center btn-pending">
                    ...
                    <div class="col">
                        <a href="../views/in_progress.php"
                            class="btn btn-primary w-100 d-flex justify-content-between align-items-center btn-inprogress">
                            <span>En curso</span>
                            <span class="material-symbols-outlined">more_vert</span>
                        </a>
                        <div class="d-md-none mt-3">
                    ...
                    <div class="col">
                        <a href="../views/archived.php"
                            class="btn btn-primary w-100 d-flex justify-content-between align-items-center btn-archived">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="text-muted small">Este es una vista integrada de tu Calendario de
                                            Google. Puedes
                                    ...
                                    <div class="date-time-container">
                                        ...
                                        <div class="time-selector">
                                            ...
                                            <div class="time-input-group">
                                                <input type="number" class="form-control time-input" id="hour" min="1"
                                                    max="12" placeholder="H">
                                                <span>:</span>
                                                <input type="number" class="form-control time-input" id="minute" min="0"
                                                    max="59" placeholder="M">
