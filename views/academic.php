                    ...
                    <div class="col-12 welcome-section">
                        <div class="row align-items-center">
                            <div class="col-md-4 welcome-image">
                                <img src="../assets/academic.png" alt="Welcome Image" class="img-fluid">
                            </div>
                            <div class="col-md-8 welcome-text">
                                <h2>¡Bienvenido(a) Darknessss!</h2>
                                <p>Cada página que leas, cada problema que resuelvas y cada esfuerzo que hagas hoy te acercará un paso más a convertirte en la persona que quieres ser.</p>
                                <p>La constancia y el aprendizaje son el camino al éxito.</p>
                            </div>
                        </div>
                    </div>
                </div>
